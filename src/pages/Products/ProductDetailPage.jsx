...
export default function ProductDetailPage() {
  ...
  const { primaryImage, gallery } = useMemo(() => {
    ...
    if (product) {
      // support `image`, `imageUrl`, `thumbnail`, `images` array, or nested media objects
      const candidates = [
        product.image_url,
        product.imageUrl,
        product.thumbnail,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <section className="lg:col-span-6">
            ...
            {/* Short meta row (customize as your schema allows) */}
            ...
            {/* CTA row — wire up to your cart later if needed */}
